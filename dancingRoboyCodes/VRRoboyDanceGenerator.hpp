...
#include "roboy_communication_simulation/DanceMoves.h"

namespace gazebo
{
    class VRRoboyDanceGenerator : public ModelPlugin, public rviz_visualization
    {
    public:
        VRRoboyDanceGenerator();
        ~VRRoboyDanceGenerator();
        /**
    ...
    private:
         ...
         */
        void ApplyExternalForce(const roboy_communication_simulation::DanceMoves::ConstPtr &msg);
        ...
        math::Pose initPose;
        geometry_msgs::Point Target1,Target2,Target3,Target4,prevForce1,prevForce2,prevForce3,prevForce4;
